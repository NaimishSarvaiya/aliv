 ...
 */
public class SingleSelectedVisitorAdapter extends RecyclerView.Adapter<SingleSelectedVisitorAdapter.ViewHolder> {
    NotifyDialogSelectList notifyDialogSelectList;
    private List<VisitorData> visitorDataList;

    public SingleSelectedVisitorAdapter(List<VisitorData> deviceObjects, NotifyDialogSelectList notifyDialogSelectList) {
