 ...
 */
public class AddNewVisitorAdapterUncheck extends RecyclerView.Adapter<AddNewVisitorAdapterUncheck.ViewHolder> {
    private ArrayList<AddVisitor> visitors;

    public AddNewVisitorAdapterUncheck(ArrayList<AddVisitor> visitors) {
