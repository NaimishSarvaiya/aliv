...
public class InProgressFeedbackFragment extends Fragment implements RetrofitListener<FeedbackModel> {
    RecyclerView rv_inProgressFeed;
    LinearLayout noFeed;
    FeedbackListAdapter feedbackListAdapter;
    private ApiServiceProvider apiServiceProvider;
    ArrayList<FeedbackData> feedbackList = new ArrayList<>(); // Initialize list
    int page = 1;
    int totalRecords = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_in_progress_feedback, container, false);
        init(view);
        return view;
    }

    void init(View view) {
        rv_inProgressFeed = view.findViewById(R.id.rv_inProgressFeedback);
        noFeed = view.findViewById(R.id.ll_noInprogressFeedback);
        pullToRefresh = view.findViewById(R.id.pullToRefresh);
        noFeed.setVisibility(View.VISIBLE);
        rv_inProgressFeed.setVisibility(View.GONE);
    ...
    void loadFeed(int page) {
        Util.checkInternet(requireActivity(), new Util.NetworkCheckCallback() {
            ...
            public void onNetworkCheckComplete(boolean isAvailable) {
                if (isAvailable) {
                    apiServiceProvider.FeedbackList(LOGIN_DETAIL.getAppuserID(), Constant.INPROGRESS_FEED_STATUS, Constant.FEED_PAGE_LIMIT, String.valueOf(page), InProgressFeedbackFragment.this);
                } else {
                    hideLoader();
                }
            }
    ...
    public void onResponseSuccess(FeedbackModel successResponse, String apiFlag) {
        if (successResponse.statusCode == 200) {
            ...
            if (newData != null && newData.size() > 0) {
                ...
                rv_inProgressFeed.setVisibility(View.VISIBLE);
