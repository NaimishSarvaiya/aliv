...
public class RangeTimePickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View dialogView = inflater.inflate(R.layout.layout_custom_dialog_new, null);
                        ...
                        if (isEndTimeSelect) {
                            ...
                            if (validateRange) {
                                if (hourEnd > hourStart) {
                                    ...
                                    flagCorrect = hourEnd == hourStart && minuteEnd > minuteStart;
                            } else {
                                flagCorrect = true;
                            }
                            if (flagCorrect) {
    ...
    public void setOnSelectListner(ISelectedTime mCallback) {
