        ...
        try {
            Util.checkInternet(DeviceListActivity.this, new Util.NetworkCheckCallback() {
                ...
                public void onNetworkCheckComplete(boolean isAvailable) {
                    if (isAvailable) {
                        apiServiceProvider.callForDeviceList(LOGIN_DETAIL.getAppuserID(), BuildConfig.VERSION_NAME, (RetrofitListener<SuccessDeviceListResponse>) DeviceListActivity.this);
                    } else {
                        hideLoader();
                    }
                }
