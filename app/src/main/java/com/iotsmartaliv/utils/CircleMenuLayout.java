...
/**
 * This class is used for circle menu layout for home fragments.
 *
...
public class CircleMenuLayout extends ViewGroup {
    ...
    private float rippleNotRotatingX = 0.0F;
    private float rippleNotRotatingY = 0.0F;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (cView != null) {
            ...
            rippleNotRotatingX = (float)cl;
            rippleNotRotatingY = (float)(layoutRadius / 2 + cView.getMeasuredWidth() / 2);
    ...
    private Boolean isAllowToRotate(float x, float y) {

        if(x > rippleNotRotatingX && x < rippleNotRotatingY && y > rippleNotRotatingX && y < rippleNotRotatingY)
            return false;
