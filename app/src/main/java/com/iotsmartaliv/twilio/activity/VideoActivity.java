package com.iotsmartaliv.twilio.activity;
...
import com.iotsmartaliv.twilio.dialog.Dialog;
import com.iotsmartaliv.twilio.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity implements RetrofitListener<SuccessResponse> {
    ...
    LinearLayout otherOption, acceptBtnLay;
     ...
     */
    private String accessToken, roomID, senderName, senderId;
    /*
     * Android application UI elements
     */
    private TextView videoStatusTextView, tvCallerName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acceptBtnLay = findViewById(R.id.accept_btn_lay);

        accessToken = getIntent().getStringExtra("accessToken");
        roomID = getIntent().getStringExtra("roomId");
        senderName = getIntent().getStringExtra("callerName");
        senderId = getIntent().getStringExtra("senderId");
        tvCallerName.setText("Incoming Call....\n" + senderName);
        /*
        ...
        if (!checkPermissionForCameraAndMicrophone()) {
            ...
            handler = new Handler();
            handler.postDelayed(() -> {
                    Util.checkInternet(VideoActivity.this, new Util.NetworkCheckCallback() {
                        @Override
                        public void onNetworkCheckComplete(boolean isAvailable) {
                            if (isAvailable) {
                                apiServiceProvider.callApiForEndCall(senderId, VideoActivity.this);
                            }
                        }
                    });
            }, 1000 * 60);   //1 min
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CAMERA_MIC_PERMISSION_REQUEST_CODE) {
            ...
            if (cameraAndMicPermissionGranted) {
                ...
                handler = new Handler();
                handler.postDelayed(() -> {
                    apiServiceProvider.callApiForEndCall(senderId, this);
                }, 1000 * 60);   //1 min
            } else {
                Toast.makeText(this,
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                Log.d(TAG, "onConnectFailure: " + e.getExplanation());
    ...
    private DialogInterface.OnClickListener connectClickListener(final EditText roomEditText) {
        return (dialog, which) -> {
             ...
             * Connect to room
             */
            connectToRoom(roomEditText.getText().toString().trim());
        };
    }
    ...
    public void accept_call(View view) {
        ...
        handler.removeCallbacksAndMessages(null);
        acceptBtnLay.setVisibility(View.GONE);
        tvCallerName.setVisibility(View.GONE);
    ...
    public void onResponseSuccess(SuccessResponse sucessRespnse, String apiFlag) {
        switch (apiFlag) {
            case Constant.UrlPath.END_CALL_API:
    ...
    public void onResponseError(ErrorObject errorObject, Throwable throwable, String apiFlag) {
        switch (apiFlag) {
            case Constant.UrlPath.END_CALL_API:
                Util.firebaseEvent(Constant.APIERROR, VideoActivity.this,Constant.UrlPath.SERVER_URL+apiFlag, LOGIN_DETAIL.getUsername(),LOGIN_DETAIL.getAppuserID(),errorObject.getStatus());
